...
public class TestLeaseSzw {
  ...
  static final Log LOG = LogFactory.getLog(TestLeaseSzw.class);
  ...
  public void testFactory() throws Exception {
    ...
    out1.write("sdfsf".getBytes());
    final DFSClient c2 = createDFSClientAs(ugi[1], conf);
    FSDataOutputStream out2 = createFsOut(c2, "/out1");
    out2.write("tttt".getBytes());
    System.out.println(c1.getLeaseRenewer().toString());
    System.out.println(c2.getLeaseRenewer().toString());
