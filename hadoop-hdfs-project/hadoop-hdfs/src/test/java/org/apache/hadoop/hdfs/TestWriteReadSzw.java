...
public class TestWriteReadSzw {
  ...
  static private Log LOG = LogFactory.getLog(TestWriteReadSzw.class);
  ...
  private void initClusterModeTest() throws IOException {
    ...
    LOG = LogFactory.getLog(TestWriteReadSzw.class);
  ...
  public static void main(String[] args) {
    try {
      TestWriteReadSzw trw = new TestWriteReadSzw();
